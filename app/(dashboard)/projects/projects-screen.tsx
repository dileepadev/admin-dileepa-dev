 ...
 */
export function ProjectsScreen({ records }: { records: Project[] }) {
  return (
    <ResourceManager<Project>
      ...
      columns={[
        ...
        { header: 'Status', cell: (row) => <Badge>{humanise(row.status)}</Badge> },
        {
          header: 'Featured',
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { kind: 'list', name: 'tags', label: 'Tags' },
              {
                ...
                label: 'Highlights',
                wide: true,
                hint: 'One per line. These are sentences, so they are not comma separated.',
              },
            ],
          },
          {
            ...
            fields: [
              ...
              { kind: 'url', name: 'links.package', label: 'Package' },
            ],
          },
          {
            legend: 'Cover',
        ...
        groups: [
          {
            ...
            fields: [
              { kind: 'image', name: 'url', label: 'Image', folder: 'projects' },
